...
import {Any, Message as Message$1, NullValue, proto3} from "@bufbuild/protobuf";
...
export class ErrorStatus extends Message$1<ErrorStatus> {
  ...
  /**
   * @generated from field: google.protobuf.NullValue null_value = 3;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "null_value", kind: "enum", T: proto3.getEnumType(NullValue) },
  ]);
